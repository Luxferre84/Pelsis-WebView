...
<head>
    ...
    <link rel="stylesheet" href="style/stylebss.css">
...
<body>
    ...
    <div class="boxdiklat">
    <div class="events">
        <a href="mengenalpelsissulut.php" class="event-box">
            <div class="pagewrap"> 
                <div class="title2">Halo, Fabian Josua Liow terima kasih telah daftar di Diklat Kepemimpinan Siswa Kristen. Untuk selanjutnya, akan segera di hubungi oleh panitia.</div>
            </div>
        </a>
    </div>
    <div class="events">
